...
impl PadVoice {
    pub fn new() -> Self {
        Self { sample: ArcSwap::from_pointee(PadSample::empty()), playing: AtomicBool::new(false), frame_bits: AtomicU64::new(0f64.to_bits()), gain: AtomicF32::new(1.0), width: AtomicF32::new(1.0) }
    }
    pub fn trigger(&self) { self.frame_bits.store(0f64.to_bits(), Ordering::Release); self.playing.store(true, Ordering::Release); }
